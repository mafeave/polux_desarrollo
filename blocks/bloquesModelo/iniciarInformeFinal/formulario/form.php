...
<div id="contenido">
	...
	<div class="area-msg">
		...
		<table id="tInfo">
			...
			<tr>
				<td><b>Titulo:</b></td>
				<td><?php echo $matrizProyecto[0][1];?></td>
			</tr>
			<tr>
				<td><b>Descripcion:</b></td>
				<td><?php echo $matrizProyecto[0][2];?></td>
			</tr>
			<tr>
		...
		for($i = 0; $i < count ( $matrizProyecto ); $i ++) {
			echo $matrizProyecto [$i] [3] . " - " . $matrizProyecto [$i] [4];
		}
		?>
		</td>
			</tr>
			<tr>
				...
				<td>Versión No. <?php echo $matrizProyecto[0][5];?></td>
			</tr>
		</table>
		...
		<h3>Información requerida para el inicio del informe final</h3>
<?php

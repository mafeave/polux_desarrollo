...
<div class="bg-seccion corner ">
	...
	<div class="seccion corner margen-interna ">
		...
		<?php
		$atributos ['mensaje'] = 'Nueva versión de documento de proyecto';
		...
		<br>
			...
			<div class="corner seccion-contenido ">
		...
		?>
				...
				<tr>
					<td><b>Nueva versión del documento:</b></td>
					<td>Versión No. <?php echo $matrizVersiones[0][0]+1;?></td>
				</tr>
			</table>
		</div>
		<br>

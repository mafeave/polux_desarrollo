...
class Formulario {
	...
	function formulario() {
		...
		$cadena_sql = $this->miSql->getCadenaSql ( "buscarHistorial", $_REQUEST ['id'] );
		$resultado = $esteRecurso->ejecutarAcceso ( $cadena_sql, "busqueda" );
		...
		$variable .= "&numanteproyecto=".$_REQUEST ['id'];

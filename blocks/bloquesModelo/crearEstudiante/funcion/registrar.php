...
class Registrar {
	...
	function procesarFormulario() {
		...
		$arregloDatos = array (
				...
				'nombres' => $_REQUEST ['nombreEstudiante'],
				'apellidos' => $_REQUEST ['apellidos'],
				'correo' => $_REQUEST ['emailEstudiante'],
				...
				//estudiante con el id_usuario
				'programaCurricular' => $_REQUEST ['seleccionarProgramaCurricular'],
				'codigo' => $_REQUEST ['codigoEstudiante'],
		...
		if (! $resultadoUsuario) {
			...
			if ($resultadoEstado) {
				...
				$this->cadena_sql = $this->miSql->getCadenaSql ( "registrarEstudiante", $arregloDatos );
				$resultadoPerfil = $esteRecursoDB->ejecutarAcceso ( $this->cadena_sql, "acceso" );

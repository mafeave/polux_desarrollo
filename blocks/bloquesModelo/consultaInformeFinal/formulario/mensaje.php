...
if (! isset ( $GLOBALS ["autorizado"] )) {
	...
	else if ($_REQUEST ['mensaje'] == 'confirma3') {
		$tipo = 'success';
		$mensaje = $this->lenguaje->getCadena ( 'mensajeRegistro3' );
		$boton = "continuar";
	...
	else if ($_REQUEST ['mensaje'] == 'error3') {
		$tipo = 'error';
		$mensaje = $this->lenguaje->getCadena ( 'mensajeError3' );
		$boton = "regresar";
		$valorCodificado = "pagina=" . $esteBloque ['nombre'];
		$valorCodificado .= "&opcion=nuevo";
		$valorCodificado .= "&bloque=" . $esteBloque ["id_bloque"];

...
namespace bloquesModelo\infFinalesxEstudiante\formulario;
...
class Formulario {
	...
	function formulario() {
		...
		if (isset ( $_REQUEST ['variable'] )) {
			...
			$atributos ['mensaje'] = 'Informes finales por estudiante - ' . $matrizNombre [0] [0] . " - ";
		} else {
			$atributos ['mensaje'] = 'Informes finales por estudiante ';
		}
...
<div class="bg-caja corner" id="caja<?php echo $i ?>"
	...
	<div class="caja corner">
		<div class="caja-header">
			<div class="caja-fecha" style="float: left"><?php echo $matrizInformes[$i]['fecha']?></div>
			<div class="clearboth">
				<br></br>
			</div>
		</div>
			...
			<div class="caja-info" style="float: left">
				<table style="border: 0; width: 100%">
					<tbody>
						<tr>
							<td><b>Titulo:</b></td>
							<td><?php echo $matrizInformes[$i]['titulo'] ?></td>
						</tr>
						<tr>
							<td><b>Modalidad:</b></td>

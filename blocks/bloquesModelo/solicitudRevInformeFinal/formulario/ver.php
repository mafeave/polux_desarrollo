...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['id'] = '';
		$atributos ['estilo'] = "table-tittle estilo_tr";
		$atributos ['mensaje'] = 'Documento a evaluar:';
		$atributos ['tipo_etiqueta'] = "td";
		echo $this->miFormulario->div_especifico ( "inicio", $atributos );
		echo $this->miFormulario->div_especifico ( "fin", $atributos );
		unset ( $atributos );
		...
		$atributos ['id'] = "p";
		$atributos ['estilo'] = "";
		$atributos ['mensaje'] = 'Versión No. 1';
		$atributos ['tipo_etiqueta'] = "td";
		echo $this->miFormulario->div_especifico ( "inicio", $atributos );
		echo $this->miFormulario->div_especifico ( "fin", $atributos );
		unset ( $atributos );
		...
		$atributos ['id'] = "p";
		$atributos ['estilo'] = "";
		$atributos ['mensaje'] = $matrizItems[0][5];
		$atributos ['tipo_etiqueta'] = "td";
		echo $this->miFormulario->div_especifico ( "inicio", $atributos );
		echo $this->miFormulario->div_especifico ( "fin", $atributos );
		unset ( $atributos );
		...
		$atributos ['id'] = '';
		$atributos ['estilo'] = "table-tittle estilo_tr";
		$atributos ['mensaje'] = 'Iteración de revisión:';
		$atributos ['tipo_etiqueta'] = "td";
		echo $this->miFormulario->div_especifico ( "inicio", $atributos );
		echo $this->miFormulario->div_especifico ( "fin", $atributos );
		unset ( $atributos );

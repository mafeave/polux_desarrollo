...
namespace bloquesModelo\informesFinalesPorFinalizar\formulario;
...
class Formulario {
	...
	if (($rol == 'Administrador General') || ($rol == 'Desarrollo y Pruebas')) {
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarInformesPorFinalizar");
		$matrizItems = $esteRecurso->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
		
		?>

<h2>Informes Finales por Finalizar </h2>
<br>

...
namespace bloquesModelo\evaluacionInforme\funcion;

use bloquesModelo\evaluacionInforme\funcion\redireccionar;
...
class Registrar {
	...
	function procesarFormulario() {
		...
		$matrizDocumento = $esteRecursoDB->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
		$documento = $matrizDocumento [0] [0];
		var_dump ( $documento );
		...
		// guardar historial de cambio de estado de la solicitud
		//$cadenaSql = $this->miSql->getCadenaSql ( 'guardarHistorialSol', $_REQUEST );

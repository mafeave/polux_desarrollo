...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['tipoFormulario'] = 'width=device-width, initial-scale=1';
...
<?php
				...
				$atributos ["verificar"] = '';
				$atributos ["tipoSubmit"] = ''; // Dejar vacio para un submit normal, en este caso se ejecuta la funci�n submit declarada en ready.js

...
class registrarForm {
	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[5][3];
			...
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[5][2];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[6][2];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[7][3];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[7][2];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[8][3];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			$atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
			$atributos ['validar'] = '';
			$atributos ['valor'] = $matrizRevision[8][2];
			$atributos ['titulo'] = $this->lenguaje->getCadena ( $esteCampo . 'Titulo' );
			$atributos ['deshabilitado'] = true;
			$atributos ['tamanno'] = 57;
			$atributos ['maximoTamanno'] = '';
			...
			unset ( $atributos );
			{
				...
				<button type="button" id="btnAnt" class="btn btn-primary btn-lg active">Anterior</button>
